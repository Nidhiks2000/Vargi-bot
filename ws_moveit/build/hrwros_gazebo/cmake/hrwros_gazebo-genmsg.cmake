...
set(MSG_I_FLAGS "-Ihrwros_gazebo:/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/srv/VacuumGripperControl.srv" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/srv/VacuumGripperControl.srv" ""
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/Proximity.msg" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/Proximity.msg" "std_msgs/Header"
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/srv/ConveyorBeltControl.srv" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/srv/ConveyorBeltControl.srv" "hrwros_gazebo/ConveyorBeltState"
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/Model.msg" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/Model.msg" "geometry_msgs/Pose:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/LogicalCameraImage.msg" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/LogicalCameraImage.msg" "geometry_msgs/Pose:hrwros_gazebo/Model:geometry_msgs/Quaternion:geometry_msgs/Point"
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/VacuumGripperState.msg" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/VacuumGripperState.msg" ""
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/ConveyorBeltState.msg" NAME_WE)
add_custom_target(_hrwros_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "hrwros_gazebo" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/ConveyorBeltState.msg" ""
)
...
_generate_msg_cpp(hrwros_gazebo
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Pose.msg;/home/nidhi/ws_moveit/src/vb_simulation_pkgs/hrwros_gazebo/msg/Model.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Quaternion.msg;/opt/ros/melodic/share/geometry_msgs/cmake/../msg/Point.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/hrwros_gazebo
)
_generate_msg_cpp(hrwros_gazebo
