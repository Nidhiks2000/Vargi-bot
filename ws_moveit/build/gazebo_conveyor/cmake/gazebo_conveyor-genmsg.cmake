...
set(MSG_I_FLAGS "-Igazebo_conveyor:/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/srv/ConveyorBeltControl.srv" NAME_WE)
add_custom_target(_gazebo_conveyor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gazebo_conveyor" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/srv/ConveyorBeltControl.srv" ""
)

get_filename_component(_filename "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/msg/ConveyorBeltState.msg" NAME_WE)
add_custom_target(_gazebo_conveyor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gazebo_conveyor" "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/msg/ConveyorBeltState.msg" ""
)
...
_generate_msg_cpp(gazebo_conveyor
  "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/msg/ConveyorBeltState.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(gazebo_conveyor
  "/home/nidhi/ws_moveit/src/vb_simulation_pkgs/gazebo-conveyor/srv/ConveyorBeltControl.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/gazebo_conveyor
)
