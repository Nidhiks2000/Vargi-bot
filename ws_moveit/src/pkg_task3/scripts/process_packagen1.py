...
'''
# This python script processes packagen1
# ROS- PROCESS_PACKAGEN1 SCRIPT 
...
def main():
    ...
    def callback(msg):
        ...
        if msg.models[1].type == "packagen1":
            ...
            rospy.loginfo('\033[94m' + " EE to package from current position." + '\033[0m')

            #getting the translation value to grap the package                                                
            ur5.ee_cartesian_translation(0,res[2],0)

            #rospy.signal_shutdown("red process finished")
            service.activate_vacuum_gripper(True)
            ur5.attach_box()
            
            #going to bin red pose
            ur5.ee_cartesian_translation(0.80,0,0) #go to red bin
