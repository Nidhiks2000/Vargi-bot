...
def main():
    ...
    while True:
        ...
        def callback(msg):
            ...
            if msg.models[0].type == "ur5" and msg.models[1].type == "packagen3" and msg.models[0].pose.position.y == ur5_2_home_pose.position.y:
                ...
                ur5.ee_cartesian_translation(0,res[0],0)
