...
def main():
    ...
    service.activate_conveyor_belt(35)
    ...
    ur5_2_home_pose.position.x = -0.2
    ...
    #service.activate_conveyor_belt(30)

    #def callback(msg):

        #if msg.models[1].type == "packagen1":

            #service.activate_conveyor_belt(2)
            ...
            #ur5.ee_cartesian_translation(0.75,0,0)
            #service.activate_vacuum_gripper(False)
            #rospy.sleep(0.1)
            #ur5.go_to_pose(ur5_2_home_pose)
            #service.activate_conveyor_belt(0)
