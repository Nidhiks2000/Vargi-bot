...
class Ur5Moveit:
    ...
    def __init__(self, arg_robot_name):
        ...
        rospy.init_node('yellow', anonymous=True)
...
def main():
    ...
    def callback(msg):
        ...
        if msg.models[1].type == "packagen02" or "packagen10" or "packagen20":



            activate_conveyor_belt(9)
            rospy.sleep(3.5)
            activate_conveyor_belt(0)
            
            activate_vacuum_gripper(True)

            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path, 'home_to_yellowbin.yaml', 5)
            activate_vacuum_gripper(False)
            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path,'yellowbin_to_home.yaml',5)
