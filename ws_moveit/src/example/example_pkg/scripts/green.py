...
def main():
    ...
    def callback(msg):
        ...
        if msg.models[1].type == "packagen01" or "packagen10" or "packagen22":
            ...
            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path, 'home_to_greenbin.yaml', 5)
            activate_vacuum_gripper(False)
            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path,'greenbin_to_home.yaml',5)
