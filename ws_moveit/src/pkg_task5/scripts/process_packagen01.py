...
class Ur5Moveit:
    ...
    def __init__(self, arg_robot_name):
        ...
        rospy.init_node('process_packagen01', anonymous=True)
...
def main():
    ...
    def callback(msg):
        ...
        if msg.models[1].type == "packagen01":
            ...
            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path, 'home_to_yellowbin.yaml', 1)
            activate_vacuum_gripper(False)
            ur5.moveit_hard_play_planned_path_from_file(ur5._file_path,'yellowbin_to_home.yaml',1)
            activate_conveyor_belt(100)
            rospy.signal_shutdown("packagen01 done")
